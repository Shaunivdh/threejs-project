...
vi.mock("../components/codeop/LoungeChair", () => ({ default: () => null }));
vi.mock("../components/codeop/Pots", () => ({ default: () => null }));
vi.mock("../components/brighton/Laptop", () => ({ default: () => null }));
vi.mock("../components/codeop/Coffee", () => ({ default: () => null }));
vi.mock("../components/codeop/PalmTree", () => ({ default: () => null }));
vi.mock("../components/codeop/Books", () => ({ default: () => null }));
